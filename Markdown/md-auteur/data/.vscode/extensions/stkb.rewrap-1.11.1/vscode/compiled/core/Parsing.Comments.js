...
function stripLines(prefixRegex, prefixLength, tabWidth, eraseIndentedMarker) {
  var stripLine;
  return (0, _CurriedLambda.default)((stripLine = $var4 => function (tupledArg_1) {
    return tupledArg_1[0] + tupledArg_1[1];
  }(($var3 => {
    var f;
    return (f = function (pre) {
      return eraseIndentedMarker ? function (str_1) {
        return _Prelude.String.dropStart(prefixLength, str_1);
      }((0, _String2.replicate)(pre.length, " ")) : _Prelude.String.dropStart(prefixLength, pre);
    }, function (tupledArg) {
...
function decorationLinesParser(fn, lines) {
    ...
    loop: while (true) {
      ...
      if (matchValue == null) {
        ...
        if (matchValue_1 == null) {
          return new _List.default((0, _Option.getValue)(matchValue), output);
        } else {
          output = new _List.default((0, _Option.getValue)(matchValue), output);
  ...
  return (0, _Option.defaultArg)((0, _Nonempty.fromList)(loop(new _List.default(), lines)), null, function (newLinesRev) {
    return [(0, _Nonempty.singleton)(new _Block.Block(2, (0, _Nonempty.rev)()(newLinesRev))), (0, _Nonempty.fromList)(_Prelude.List.safeSkip((0, _Nonempty.length)()(newLinesRev), (0, _Nonempty.toList)(lines)))];
  });
}
...
function lineComment(contentParser, marker, settings) {
  ...
  const linesToComment = function (lines) {
    ...
    otherLinesParser = $var6 => {
      var parser;
      var prefixes;
      return (parser = $var5 => (0, _CurriedLambda.default)(contentParser)(settings)(stripLines(prefixRegex, patternInput[1], settings.tabWidth, true)($var5)), function (tupledArg) {
  ...
  const linesToComment = function (lines) {
    ...
    const stripLine = $var10 => {
      return function (tupledArg) {
        return _Prelude.String.dropStart(patternInput_1[1], tupledArg[0]) + tupledArg[1];
    ...
    const otherLinesParser = $var12 => {
      var parser;
      return (parser = (0, _CurriedLambda.default)(contentParser)(settings), function (tupledArg_1) {
    ...
    stdParser = (0, _Parsing.repeatToEnd)((0, _CurriedLambda.default)(function (totalParser) {
    ...
    const beginParser = function (lines_6) {
      const otherLinesParser_1 = $var15 => {
        var parser_1;
        return (parser_1 = (0, _CurriedLambda.default)(contentParser)(settings), function (tupledArg_2) {
    ...
    if (matchValue[1] == null) {
      ...
      blocks = _Prelude.Nonempty.op_Addition(matchValue[0], stdParser(remainingLines));
    }
