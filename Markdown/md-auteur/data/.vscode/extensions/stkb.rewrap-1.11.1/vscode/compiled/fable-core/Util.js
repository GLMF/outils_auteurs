...
exports.clear = clear;
exports.ObjectRef = exports.Unit = exports.Any = exports.NonDeclaredType = void 0;
...
class NonDeclaredType {
  ...
  Equals(other) {
    if (this.kind === other.kind && this.definition === other.definition) {
      return typeof this.generics === "object" // equalsRecords should also work for Type[] (tuples)
...
function extendInfo(cons, info) {
  ...
  if (typeof parent[_Symbol.default.reflection] === "function") {
    const newInfo = {};

    const parentInfo = parent[_Symbol.default.reflection]();
...
function hasInterface(obj, interfaceName) {
  ...
  } else if (typeof obj[_Symbol.default.reflection] === "function") {
    const interfaces = obj[_Symbol.default.reflection]().interfaces;
...
function getPropertyNames(obj) {
  ...
  const propertyMap = typeof obj[_Symbol.default.reflection] === "function" ? obj[_Symbol.default.reflection]().properties || [] : obj;
...
function toString(obj, quoteStrings = false) {
  ...
  if (hasInterface(obj, "FSharpUnion")) {
    const info = obj[_Symbol.default.reflection]();
...
function equals(x, y) {
  ...
  if (x === y) {
    ...
    return x === y; // Equals override or IEquatable implementation
...
function compare(x, y) {
  ...
  if (x === y) {
    ...
    return x === y ? 0 : x < y ? -1 : 1; // Some types (see Long.ts) may just implement the function and not the interface
...
function isList(o) {
  if (o != null) {
    if (typeof o[_Symbol.default.reflection] === "function") {
      return o[_Symbol.default.reflection]().type === "Microsoft.FSharp.Collections.FSharpList";
    }
  }
...
function createObj(fields, caseRule = CaseRules.None, casesCache) {
  ...
  while (!cur.done) {
    ...
    if (Array.isArray(value)) {
      ...
      if (cases == null) {
        if (typeof proto[_Symbol.default.reflection] === "function") {
          cases = proto[_Symbol.default.reflection]().cases;
