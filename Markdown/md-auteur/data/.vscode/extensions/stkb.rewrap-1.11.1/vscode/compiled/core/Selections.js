...
const normalizeRanges = (0, _CurriedLambda.default)((() => {
        ...
        if (input.tail.tail != null) {
          if (input.head.endLine === input.tail.head.startLine) {
            if (input.head.isEmpty ? input.tail.head.isEmpty : false) {
              output = output;
              input = new _List.default(input.tail.head, input.tail.tail);
              continue loop;
            } else if (input.head.isEmpty) {
              const matchValue = input.tail.head.shiftStartDown;

              if (matchValue != null) {
                output = new _List.default(input.head, output);
                input = new _List.default((0, _Option.getValue)(matchValue), input.tail.tail);
                continue loop;
              } else {
                output = new _List.default(input.head, output);
              ...
              if (matchValue_1 != null) {
                output = new _List.default((0, _Option.getValue)(matchValue_1), output);
                input = new _List.default(input.tail.head, input.tail.tail);
                continue loop;
              } else {
                output = output;
              ...
              output = output;
              input = new _List.default(LineRange.fromStartEnd.bind(LineRange)(input.head.startLine, input.tail.head.endLine), input.tail.tail);
              continue loop;
            }
          } else {
            output = new _List.default(input.head, output);
          ...
          return new _List.default(input.head, output);
        }
      } else {
        return output;
      }
  ...
  return $var1 => (0, _List.reverse)((0, _CurriedLambda.default)(loop)(new _List.default())($var1));
})());
...
class ParseResult {
  ...
  [_Symbol2.default.reflection]() {
    return {
      ...
      properties: {
        startLine: "number",
        originalLines: (0, _Util.makeGeneric)(_Prelude.Nonempty, {
          T: "string"
        }),
        blocks: (0, _Util.makeGeneric)(_Prelude.Nonempty, {
          T: _Block.Block
        })
      }
    };
...
function processBlocks(settings, selections, parseResult) {
  const splitBlock = function (n, block) {
    ...
    if (block.tag === 2) {
      ...
      return (f_2 = (mapping_1 = function (ls) {
        ...
        return _Prelude.Tuple.mapSecond(f_2, tupledArg_2[0], tupledArg_2[1]);
      })((f_3 = function (ls_1) {
        return new _Block.Block(1, [[pHead, pTail], ls_1]);
      }, function (tupledArg_3) {
        return _Prelude.Tuple.mapFirst(f_3, tupledArg_3[0], tupledArg_3[1]);
  ...
  const loop = function (output, sels, start, _arg1, origLines) {
    ...
    loop: while (true) {
          ...
          case 0:
            if (hasEmptySelection) {
              ...
              patternInput_1 = function (tupledArg_4) {
                return _Prelude.Tuple.mapFirst(patternInput[1], tupledArg_4[0], tupledArg_4[1]);
      ...
      const patternInput_2 = patternInput_1[1] == null ? [blockLength, _arg1.data[1]] : [blockLength - (0, _Block.length)((0, _Option.getValue)(patternInput_1[1])), new _List.default((0, _Option.getValue)(patternInput_1[1]), _arg1.data[1])];
      const patternInput_3 = (f_4 = function (oL) {
        return (0, _Option.defaultArg)(patternInput_1[0], oL);
      }, function (tupledArg_5) {
        return _Prelude.Tuple.mapFirst(f_4, tupledArg_5[0], tupledArg_5[1]);
      })((0, _Nonempty.splitAt)(patternInput_2[0], origLines));

      const nextOutput = function (_arg2) {
        return new _Prelude.Nonempty(0, [_arg2.data[0], (0, _List.append)(_arg2.data[1], output)]);
  ...
  return loop(new _List.default(), selections, parseResult.startLine, parseResult.blocks, parseResult.originalLines);
}
