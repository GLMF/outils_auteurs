...
exports.default = exports.MapTree = void 0;

var _Comparer = _interopRequireDefault(require("./Comparer"));
...
function tree_collapseLHS(stack) {
  if (stack.tail != null) {
    ...
    return new _ListClass.default();
  }
}

function tree_mkIterator(s) {
  return {
    stack: tree_collapseLHS(new _ListClass.default(s, new _ListClass.default())),
    started: false
  };
}
...
function from(comparer, tree) {
  ...
  map.tree = tree;
  map.comparer = comparer || new _Comparer.default();
  return map;
}

function create(ie, comparer) {
  comparer = comparer || new _Comparer.default();
